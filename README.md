# UI Foundry Tabs Studio

Standalone visual Tabs generator built with Next.js, React, and TypeScript.

Standalone Tabs component studio for building native, preview-honest, React-exportable UI patterns that match the UI Foundry product line.
...
- designers building Tabs UI quickly
- developers who need editable React starting points
- marketplace buyers who want a self-contained Tabs generator
...
The editor is focused on controls that are native to Tabs and useful in real product work:
- tab count, active tab, orientation, panel content, disabled tabs, and fitted/scrollable intent
- trigger, indicator, panel, radius, border, shadow, color, hover, focus, and active styling
- dashboard, settings, product, and content tab variants
- tablist/tab/panel semantics and keyboard expectations
- React export for tabs structure

The goal is maximum useful depth without adding unrelated controls that would make the component stop reading as Tabs.
...
This repo is intended to publish as Abid-Al-Hossain/UI_tabs.
