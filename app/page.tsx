...
export default function Page() {
  const [state, setState] = useState<TabsState>(DEFAULT_TABS_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Tabs Studio" controls={controls} preview={output} /></AppShell>;
}
